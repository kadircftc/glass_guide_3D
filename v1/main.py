...
def main():
    ...
    #ax.scatter(SURF_glass['points']['x'], SURF_glass['points']['y'], SURF_glass['points']['z'], c='r', marker='.')
    ...
    #fig = plt.figure()
    #ax = fig.add_subplot(111, projection='3d')
    #ax.scatter(SURF_normal2glass['points']['x'], SURF_normal2glass['points']['y'], SURF_normal2glass['points']['z'], c='r', marker='.')
    #ax.scatter(normal_sf_point['x'], normal_sf_point['y'], normal_sf_point['z'], c='b', marker='.')
    #ax.scatter(GLASS_TRIMLINE_POINTS['x'], GLASS_TRIMLINE_POINTS['y'], GLASS_TRIMLINE_POINTS['z'], c='g', marker='o',s=10)
    #ax.scatter(offset_normal2glass_points['x'], offset_normal2glass_points['y'], offset_normal2glass_points['z'], c='y', marker='.')
    #plt.show() 
    ...
    # Cut top and bottom glass guide
